                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('obat-keluar.update', $obkel->id) }}" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                            
                                <div class="row mb-3">
                                    <label for="jenis" class="col-sm-2 col-form-label">Tanggal Obat Keluar</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control" name="keterangan_keluar" style="height: 100px">{{ $obkel->keterangan_keluar }}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="satuan" value="{{ $obkel->satuan }}" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="jumlah" value="{{ $obkel->jumlah }}" class="form-control">
                                    </div>
                                </div>
